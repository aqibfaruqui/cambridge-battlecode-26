...
def _explore_info_score(self: Harvester, x: int, y: int) -> int:
...
def _resume_patrol_if_possible(self: Harvester) -> bool:
...
def _idle_rejoin_direction(self: Harvester, c: Controller) -> Direction | None:
