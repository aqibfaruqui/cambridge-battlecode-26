...
class DStarLite:
    ...
    def __init__(
        ...
        *,
        ...
        # Snapshot of env._array for incremental change detection. The env
        # eagerly mirrors observations under every symmetry hypothesis and
        # rebinds env._array to the active one, so this single buffer always
        # tracks whatever the env currently considers ground truth.
