...
def _is_valid_join_pos(self: Axioniter, c: Controller, join_pos: Position) -> bool:
...
def _finish_foundry_join(self: Axioniter, c: Controller, join_pos: Position) -> None:
...
def try_join_axionite_to_titanium_chain(
    self: Axioniter, c: Controller, join_pos: Position
) -> bool:
