...
A retrieval-augmented generation tool for querying the game docs in `docs/`. Uses VoyageAI embeddings and Claude to answer questions. Requires `ANTHROPIC_API_KEY` and `VOYAGE_API_KEY` in `.env`.
