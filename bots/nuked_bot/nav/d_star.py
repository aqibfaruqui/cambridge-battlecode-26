...
class DStarLite:
    ...
    def __init__(self, env: EnvironmentMap, goal_x: int, goal_y: int):
        self._env = env
        self._w = env._w
        self._h = env._h
    ...
    def _blocked(self, idx: int) -> bool:
        return (_BLOCK_MASK >> self._env._array[idx]) & 1
