...
| `MAX_TEAM_UNITS`               | 50    | Maximum living units per team, including core  |
...
| `GUNNER_AXIONITE_DAMAGE`           | 40     | Gunner damage when loaded with axionite  |
...
| `GUNNER_ROTATE_COOLDOWN`           | 1      | Action cooldown after rotating           |
